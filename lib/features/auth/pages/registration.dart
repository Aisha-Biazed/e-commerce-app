                  ...
                  children: [
                      ...
                      builder: (BuildContext context) => ElevatedButton(
                        onPressed: () {
                          ...
                          if (_formkey.currentState!.isValid) {
                            ...
                            AuthCubit.get(context).getInfoFromRegister(
                              valEmail: _formkey.currentState!.value['email'],
                              valPassword:
                                  _formkey.currentState!.value['password'],
                              valUserName:
                                  _formkey.currentState!.value['username'],
                          ...
                          context.goNamed(
                              GRouter.config.productRoutes.productScreen);
                        },
                    ...
                    ElevatedButton(
                        onPressed: () {
                          ...
                          context
                              .goNamed(GRouter.config.authRoutes.profileScreen);
                        },
                        style: ButtonStyle(
